...
import { allUsersReducer, forgortPasswordReducer, profileReducer, userDetailsReducer, userReducer } from "./reducers/userReducer";
...
const reducer = combineReducers({
    ...
    forgotPassword: forgortPasswordReducer,
    cart: cartReducer,
