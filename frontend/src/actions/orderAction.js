...
export const myOrders = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${process.env.REACT_APP_API_ROUTE}/api/v1/orders/me`, config);
...
export const getOrderDetails = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${process.env.REACT_APP_API_ROUTE}/api/v1/order/${id}`, config);
